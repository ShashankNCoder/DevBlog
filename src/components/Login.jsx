...
function Login() {
        ...
        try {
            ...
            if (session) {
                ...
                if(userData) {
                    ...
                    // Redirect to the attempted URL or all-posts
                    const from = location.state?.from || '/all-posts'
    ...
    return (
        <div className='flex items-center justify-center w-full min-h-screen py-20 overflow-x-hidden'>
