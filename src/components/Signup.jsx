...
function Signup() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen py-20 overflow-x-hidden w-full py-8 min-h-screen bg-gradient-to-br from-gray-400 via-gray-300 to-gray-300">
